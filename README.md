...
* [OpenPaw](https://github.com/daxaur/openpaw) - a CLI tool that adds GitHub skills (PRs, issues, Actions) to Claude Code via `gh`, along with 37 other productivity skills.
