...
* [GitBench](https://gitbench.builtbyzee.com/) - a free and open-source Git client for working across many repositories at once, with a visual commit graph and inline diffs. Windows, Mac & Linux.
