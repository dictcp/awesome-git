...
* [gitty](https://github.com/Omibranch/gitty) - minimal Git + GitHub CLI wrapper that replaces the `add → commit → push` cycle with one command and adds human-readable shortcuts for common operations.
