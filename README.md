...
- [VaultScan – Community Edition](https://github.com/pavangajjala/vaultscan-community) - Privacy-first, offline secret scanner for Git repositories. No agents, no cloud—100% local analysis.
