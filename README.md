...
* [git-parsec](https://github.com/erishforG/git-parsec) - Git worktree lifecycle manager that ties worktrees to issue tickets (Jira, GitHub Issues, GitLab) for parallel development workflows.
