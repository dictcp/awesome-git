...
* [Git merge vs. Git Rebase: What's the difference?](https://www.loginradius.com/blog/async/git-rebase-vs-git-merge/) - Differce between GIT merge and Rebase with examples
